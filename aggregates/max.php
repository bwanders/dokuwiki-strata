...
class plugin_strata_aggregate_max extends plugin_strata_aggregate {
    ...
    function getInfo() {
        return array(
            'desc'=>'Returns the maximum value. Any item that does not have a clear numeric value (i.e. starts with a number) is counted as 0. If the \'strict\' hint is used, values that are not strictly numeric (i.e. contains only a number) are ignored.',
